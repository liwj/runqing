...
jQuery.fn.pagination = function(maxentries, opts){
	...
	return this.each(function() {
		...
		function drawLinks() {
			...
			panel.append(last);
			panel.append("<b> 第"+(parseInt(current_page)+1)+"页/共"+np+"页  跳到</b>");
			panel.append("<input style=\"padding: 0px 3px; width: 20px; height: 20px; margin-top:-6px; _ margin-top:-7px; margin-right:5px; line-height:20px;\" id=\"goVal\" value=\""+(parseInt(current_page)+1)+"\" type=\"text\">");
			panel.append("<b>页</b>");
			panel.append("<button class=\"btn btn-navy\" style=\"height: 22px;line-height: 20px;padding:0 5px 4px;margin-top:5px; margin-left:5px;\" id='go'>转</button>");
			$("#go").click(function(){
				var reg = /^[0-9]*[0-9][0-9]*$/;
				var val = 1;
